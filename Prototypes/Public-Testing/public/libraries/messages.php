<?php
    ...
    class ChatInteractions {
        ...
        public static function createChannel($channelType, $id = "", $hubId = "", $parentId = "", $participants = [], $channelName = "") {
            ...
            DBConnection::create("INSERT INTO channel_data (id, hubId, parentId, participants, channelType, channelName) VALUES (:id, :hubId, :parentId, :participants, :channelType, :channelName)", [$id, $hubId, $parentId, $participants, $channelType, $channelName], [":id", ":hubId", ":parentId", ":participants", ":channelType", ":channelName"]);
        }
