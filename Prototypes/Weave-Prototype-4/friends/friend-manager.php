...
<p id="friendFoundNotifier"><br></p> <!-- updates to inform user about status of actions being taken. Default value <br> so it fills the space even when not displaying anything -->
